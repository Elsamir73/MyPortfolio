...
const links = [
  ...
  {
    label: "LinkedIn",
    value: "linkedin.com/in/samir-pathak7",
    href: site.linkedin,
    external: true,
    icon: <LinkedInIcon />,
  },
    ...
    <section id="contact" className="section">
      <div className="container">
        ...
        <p className={styles.lead}>
          I&rsquo;m open to junior frontend roles and internships. Based in{" "}
          {site.location}. Easiest way to reach me is email, or you can find
